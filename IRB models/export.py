...
class export(object):
    ...
    def PD_toExcel(self, pd_inputs):
	     ...
	     #param data_set: development data set
          ...
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["RWEA_beg"], row_pos= 6, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["RWEA"], row_pos= 6, col_pos= 5)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["EAD_beg"], row_pos= 7, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["EAD"], row_pos= 7, col_pos= 5)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["PD_M_beg"], row_pos= 8, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["PD_M"], row_pos= 8, col_pos= 5)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["PD_K_beg"], row_pos= 9, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["PD_K"], row_pos= 9, col_pos= 5)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["Exp_def_beg"], row_pos= 10, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["Exp_def_end"], row_pos= 10, col_pos= 5)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["def_beg"], row_pos= 11, col_pos= 4)
          self.element_toExcel(wb = wbk12, element = pd_inputs["portfolio_information"]["def_end"], row_pos= 11, col_pos= 5)
